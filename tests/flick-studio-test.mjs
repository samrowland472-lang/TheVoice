...
ok('voice studio alias', sectionFor('Voice Studio') === 'clone');
...
ok('record opens studio', rec.some((c) => c.section === 'clone') && rec.some((c) => c.op === 'record'));

const openRec = parseNL('Open Voice Studio and record');
ok('open studio and record', openRec.some((c) => c.section === 'clone') && openRec.some((c) => c.op === 'record'));
