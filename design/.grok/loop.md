...
1. Path inspector: keep Points list scroll when Tab walks from a hole header onto the first point of the same hole while the list is mid-scroll.
...
2026-09-07 23:11 BST — Points list scroll holds when Shift+Tab walks from a hole’s first x onto that hole’s header mid-list.

## Next recommended

Path inspector: keep Points list scroll when Tab walks from a hole header onto the first point of the same hole while the list is mid-scroll.
