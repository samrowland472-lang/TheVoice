...
1. Named guide labels — polish inline rename and paint the name on the board stroke.
2. Guide dash preview on the board when a Print chip is hovered.
...
2026-09-19 02:40 BST — Guide dash chips on the Print row (solid / dash / tight) next to color swatches.

## Next recommended

Named guide labels — polish inline rename and show the name on the board stroke.
