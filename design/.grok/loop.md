...
1. Path inspector Shift+Tab from first hole header onto last outer-path x when last y is missing and hole 0 has no point fields.
...
2026-09-11 07:25 BST — Shift+Tab from first hole header to last outer-path y when hole 0 has no point fields.

## Next recommended

Path inspector Shift+Tab from first hole header onto last outer-path x when last y is missing and hole 0 has no point fields.
