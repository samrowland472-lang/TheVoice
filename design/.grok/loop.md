...
- Eyedropper HUD: fixed hint under the board — Click apply · kit · Shift+click save to brand kit.

## Iterations

### 2026-08-23T09:05Z — loop 33

Eyedropper HUD under the board (Click apply · kit · Shift+click save). Typecheck + build + smoke clean.
