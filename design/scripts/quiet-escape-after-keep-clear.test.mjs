...
test("quiet Escape after window-blur keep-clear still names current-dot hover", () => {
  assert.match(src, /peekCaptionAfterQuietEscapeAfterKeepClear/);
  assert.match(src, /mutedPointerUpKeep/);
  assert.match(chrome, /peekCaptionAfterQuietEscapeAfterKeepClear/);
  assert.match(chrome, /peekCaptionAfterLostCaptureCurrentHover/);
  assert.match(barrel, /peekCaptionAfterQuietEscapeAfterKeepClear/);
