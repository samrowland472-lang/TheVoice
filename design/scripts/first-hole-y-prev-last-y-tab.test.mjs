...
test("Shift+Tab from first hole-path y hops to prev hole last-point y", () => {
  assert.match(a, /function shouldShiftTabFromFirstHoleYToPrevLastY/);
  ...
  assert.match(view, /shouldShiftTabFromFirstHoleYToPrevLastY/);
...
test("first-hole y to prev last y holds Points and Holes list scroll after growth", () => {
