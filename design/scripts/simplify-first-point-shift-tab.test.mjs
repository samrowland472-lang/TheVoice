...
test("Shift+Tab from first outer-path x targets Simplify", () => {
  assert.match(a, /shouldShiftTabFromFirstOuterToSimplify/);
  ...
  assert.match(ui, /tagHolePointTabCrossing\(e\.currentTarget, simplify, simplify\)/);
