...
test("Shift+Tab from next hole first-point x hops to last hole-path y", () => {
  assert.match(a, /function shouldShiftTabFromNextHoleFirstXToLastHoleY/);
  ...
  assert.match(lastY, /function shouldShiftTabFromFirstHoleXToPrevLastY/);
  assert.match(barrel, /shouldShiftTabFromNextHoleFirstXToLastHoleY/);
  assert.match(barrel, /pickLastHoleLastPointYTabTarget/);
  assert.match(view, /function focusPrevHoleLastY/);
  assert.match(view, /shouldShiftTabFromNextHoleFirstXToLastHoleY/);
  ...
  assert.match(ui, /shouldShiftTabFromNextHoleFirstXToLastHoleY/);
  assert.match(ui, /pickLastHoleLastPointYTabTarget/);
});

test("next hole first x to last hole y holds Points and Holes list scroll after growth", () => {
